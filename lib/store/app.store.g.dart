...
mixin _$AppStore on _AppStoreBase, Store {
  final _$currentStateAtom = Atom(name: '_AppStoreBase.currentState');
  ...
  final _$busyAtom = Atom(name: '_AppStoreBase.busy');
  ...
  final _$todosAtom = Atom(name: '_AppStoreBase.todos');
